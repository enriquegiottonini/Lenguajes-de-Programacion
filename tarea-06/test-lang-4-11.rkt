...
(define-test-suite pruebas
  ...
  (test-case "list-exp"
             ...
             (check-equal? (run `(list ((- 2 1) (- 3 2) (- 2 2))))
                           (list (computation (num-val 1) '()) (computation (num-val 1) '()) (computation (num-val 0) '())))
             (check-equal? (run `(list ((newref 69) (deref 0) (setref 0 36) (deref 0) (newref 10) (deref 1))))
                           (list (computation (ref-val 0) (list (num-val 69))) (computation (num-val 69) (list (num-val 69))) (computation (num-val 36) (list (num-val 36)))
                                 (computation (num-val 36) (list (num-val 36))) (computation (ref-val 1) (list (num-val 36) (num-val 10)))
                                 (computation (num-val 10) (list (num-val 36) (num-val 10)))))
             (check-equal? (run `(list ((emptylist null) (- 6 6) (- 6 -1))))
                           (list (computation '() '()) (computation (num-val 0) '()) (computation (num-val 7) '())))))
